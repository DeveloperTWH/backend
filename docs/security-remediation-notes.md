...
| 6 | Payment amount is server-derived | Pending: no PR link available from local workspace | `46d2466b65652092c8ef1c7dd83830d4477e1338` | Tampered client amount rejected locally. Matching request charged the server-derived order total successfully. | 2026-05-20 |
